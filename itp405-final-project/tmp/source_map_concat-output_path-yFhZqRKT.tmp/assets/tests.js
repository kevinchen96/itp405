...
define('itp405-final-project/tests/controllers/profile.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/profile.js should pass jshint.\ncontrollers/profile.js: line 1, col 1, \'import\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/profile.js: line 3, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\ncontrollers/profile.js: line 37, col 9, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/profile.js: line 42, col 9, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\ncontrollers/profile.js: line 47, col 9, \'concise methods\' is available in ES6 (use \'esversion: 6\') or Mozilla JS extensions (use moz).\n\n5 errors');
  });
});
